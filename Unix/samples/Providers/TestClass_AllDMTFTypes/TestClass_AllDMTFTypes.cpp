...
void CreateInstances(MI_Context* context, unsigned int number)
{
    ...
    for(unsigned int i=0 ; i < number; i++)
    {
        ...
        TestClass_AllDMTFTypes_Set_v_sint16(instance, (MI_Sint16) ((0xFF) * -1 + (int)i));
        TestClass_AllDMTFTypes_Set_v_sint32(instance, (MI_Sint32) ((0xFFFF) * -1 + (int)i));
        TestClass_AllDMTFTypes_Set_v_sint64(instance, (MI_Sint64) ((MI_Sint64)(0xFFFFFFFF) * -1 + (int)i));
        TestClass_AllDMTFTypes_Set_v_sint8(instance, (MI_Sint8) ((0xF) * -1 + (int)i));
